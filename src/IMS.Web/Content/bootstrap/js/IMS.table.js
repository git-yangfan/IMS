...
IMS.table.prototype.load = function () {
    var _this = this;
    var _table = $("#" + _this.id);
    var _toolbar = $("#" + _this.toolbar);
    _table.bootstrapTable({
              url: _this.url,         //请求后台的URL（*）
              method: 'post',                      //请求方式（*）
              toolbar: _toolbar,                //工具按钮用哪个容器
              ...
              search:_this.searchable,                       //是否显示表格搜索，此搜索是客户端搜索，不会进服务端，所以，个人感觉意义不大
              strictSearch: false,
