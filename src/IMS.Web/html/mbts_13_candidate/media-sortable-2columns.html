...
<html>
	...
	<head>
		...
		<!-- Title -->
		<title>2 Column Sortable Portfolio | Candidate HTML Template</title>
	  ...
	  fjs.parentNode.insertBefore(js, fjs);
		...
		<section id="content">
			...
			<section class="section page-heading animate-onscroll">
				...
				<h1>2 Column Sortable Portfolio</h1>
				<p class="breadcrumb"><a href="main-v1.html">Home</a> / 2 Column Sortable Portfolio</p>
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="media-items row">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 mix category-videos category-meetings" data-nameorder="5" data-dateorder="4">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 mix category-campaign category-meetings" data-nameorder="6" data-dateorder="6">
