...
<html>
	...
	<head>
		...
		<!-- Title -->
		<title>Event post style 2 | Candidate HTML Template</title>
	  ...
	  fjs.parentNode.insertBefore(js, fjs);
		...
		<section id="content">
			...
			<section class="section page-heading animate-onscroll">
				...
				<h1>Event post style 2</h1>
				<p class="breadcrumb"><a href="main-v1.html">Home</a> / Event post style 2</p>
			...
			<section class="section full-width full-width-image animate-onscroll">
				...
				<img src="img/events/event1-big.jpg" alt="">
								...
								<div class="col-lg-12 col-md-12 col-sm-12">
									...
									<div class="event-meta horizontal">
										...
										<div class="event-meta-block col-lg-3 col-md-3 col-sm-6 animate-onscroll">
											...
											<p><a href="#">http://companyname.com</a></p>
				...
				<div class="row related-events">
						...
						<div class="event-item">
							...
							<div class="event-info">
								...
								<div class="event-content">
									<h6><a href="#">Donec porta diam eu massa</a></h6>
									<ul class="event-meta">
					...
					<div class="col-lg-4 col-md-4 col-sm-4 animate-onscroll">
						...
						<div class="event-item">
							...
							<div class="event-info">
								...
								<div class="event-content">
									<h6><a href="#">Fusce euismod consequat </a></h6>
									<ul class="event-meta">
										<li><i class="icons icon-clock"></i> 4:00 pm - 6:00 pm</li>
										<li><i class="icons icon-location"></i> 340 W 50th St.New York</li>
									</ul>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 animate-onscroll">
						...
						<div class="event-item">
							...
							<div class="event-image">
								<img src="img/events/event4.jpg" alt="">
							</div>
							...
							<div class="event-info">
								...
								<div class="event-content">
									<h6><a href="#">Aliquam dapibus tincidunt </a></h6>
									<ul class="event-meta">
										<li><i class="icons icon-clock"></i> 4:00 pm - 6:00 pm</li>
										<li><i class="icons icon-location"></i> 340 W 50th St.New York</li>
									</ul>
