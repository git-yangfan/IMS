...
<html>
	...
	<head>
		...
		<!-- Title -->
		<title>4 Column Classic Sortable Gallery | Candidate HTML Template</title>
	  ...
	  fjs.parentNode.insertBefore(js, fjs);
		...
		<section id="content">	
			...
			<section class="section page-heading animate-onscroll">
				...
				<h1>4 Column Classic Sortable Gallery</h1>
				<p class="breadcrumb"><a href="main-v1.html">Home</a> / 4 Column Classic Sortable Gallery</p>
