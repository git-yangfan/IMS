...
<html>
	...
	<head>
		...
		<!-- Title -->
		<title>3 Column Sortable Gallery | Candidate HTML Template</title>
	  ...
	  fjs.parentNode.insertBefore(js, fjs);
		...
		<section id="content">	
			...
			<section class="section page-heading animate-onscroll">
				...
				<h1>3 Column Classic Sortable Gallery</h1>
				<p class="breadcrumb"><a href="main-v1.html">Home</a> / 3 Column Classic Sortable Gallery</p>
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="media-items row">
								...
								<div class="media-image">
									...
									<div class="media-hover">
										<div class="media-icons">
											<a href="img/media/media1.jpg" data-group="media-jackbox" data-thumbnail="img/media/media1-medium.jpg" class="jackbox media-icon"><i class="icons icon-zoom-in"></i></a>
							...
							<div class="col-lg-4 col-md-4 col-sm-4 mix category-videos category-meetings" data-nameorder="2" data-dateorder="1">
							...
							<div class="media-item animate-onscroll gallery-media">
								...
								<div class="media-image">
									...
									<div class="media-hover">
										<div class="media-icons">
											<a href="https://www.youtube.com/watch?v=1WbQe-wVK9E" data-group="media-jackbox" data-thumbnail="img/media/media2-medium.jpg" class="jackbox media-icon"><i class="icons icon-play"></i></a>
											<a href="portfolio-single-sidebar.html" class="media-icon"><i class="icons icon-link"></i></a>
										</div>
									</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-4 mix category-campaign category-videos category-meetings" data-nameorder="3" data-dateorder="2">
							...
							<div class="media-item animate-onscroll gallery-media">
								...
								<div class="media-image">
									...
									<img src="img/media/media3-medium.jpg" alt="">
									
									<div class="media-hover">
										<div class="media-icons">
											<a href="https://www.youtube.com/watch?v=1WbQe-wVK9E" data-group="media-jackbox" data-thumbnail="img/media/media3-medium.jpg" class="jackbox media-icon"><i class="icons icon-play"></i></a>
											<a href="portfolio-single-sidebar.html" class="media-icon"><i class="icons icon-link"></i></a>
										</div>
									</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-4 mix category-campaign category-photos" data-nameorder="4" data-dateorder="5">
							...
							<div class="media-item animate-onscroll gallery-media">
								...
								<div class="media-image">
									...
									<img src="img/media/media4-medium.jpg" alt="">
									
									<div class="media-hover">
										<div class="media-icons">
											<a href="img/media/media4.jpg" data-group="media-jackbox" data-thumbnail="img/media/media4-medium.jpg" class="jackbox media-icon"><i class="icons icon-zoom-in"></i></a>
											<a href="portfolio-single-sidebar.html" class="media-icon"><i class="icons icon-link"></i></a>
										</div>
									</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-4 mix category-videos category-meetings" data-nameorder="5" data-dateorder="4">
							...
							<div class="media-item animate-onscroll gallery-media">
								...
								<div class="media-image">
									...
									<img src="img/media/media5-medium.jpg" alt="">
									
									<div class="media-hover">
										<div class="media-icons">
											<a href="https://www.youtube.com/watch?v=1WbQe-wVK9E" data-group="media-jackbox" data-thumbnail="img/media/media5-medium.jpg" class="jackbox media-icon"><i class="icons icon-play"></i></a>
											<a href="portfolio-single-sidebar.html" class="media-icon"><i class="icons icon-link"></i></a>
										</div>
									</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-4 mix category-campaign category-meetings" data-nameorder="6" data-dateorder="6">
							...
							<div class="media-item animate-onscroll gallery-media">
								...
								<div class="media-image">
									...
									<img src="img/media/media6-medium.jpg" alt="">
									
									<div class="media-hover">
										<div class="media-icons">
											<a href="img/media/media6.jpg" data-group="media-jackbox" data-thumbnail="img/media/media6-medium.jpg" class="jackbox media-icon"><i class="icons icon-zoom-in"></i></a>
											<a href="portfolio-single-sidebar.html" class="media-icon"><i class="icons icon-link"></i></a>
										</div>
									</div>
							...
							<div class="media-item animate-onscroll gallery-media">
								...
								<div class="media-image">
									...
									<img src="img/media/media7-medium.jpg" alt="">
									
									<div class="media-hover">
										<div class="media-icons">
											<a href="img/media/media7.jpg" data-group="media-jackbox" data-thumbnail="img/media/media7-medium.jpg" class="jackbox media-icon"><i class="icons icon-zoom-in"></i></a>
											<a href="portfolio-single-sidebar.html" class="media-icon"><i class="icons icon-link"></i></a>
										</div>
									</div>
							...
							<div class="media-item animate-onscroll gallery-media">
								...
								<div class="media-image">
									...
									<img src="img/media/media8-medium.jpg" alt="">
									
									<div class="media-hover">
										<div class="media-icons">
											<a href="https://www.youtube.com/watch?v=1WbQe-wVK9E" data-group="media-jackbox" data-thumbnail="img/media/media8-medium.jpg" class="jackbox media-icon"><i class="icons icon-play"></i></a>
											<a href="portfolio-single-sidebar.html" class="media-icon"><i class="icons icon-link"></i></a>
										</div>
									</div>
							...
							<div class="media-item animate-onscroll gallery-media">
								...
								<div class="media-image">
									...
									<img src="img/media/media9-medium.jpg" alt="">
									
									<div class="media-hover">
										<div class="media-icons">
											<a href="img/media/media9.jpg" data-group="media-jackbox" data-thumbnail="img/media/media9-medium.jpg" class="jackbox media-icon"><i class="icons icon-zoom-in"></i></a>
											<a href="portfolio-single-sidebar.html" class="media-icon"><i class="icons icon-link"></i></a>
										</div>
									</div>
