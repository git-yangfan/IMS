...
<html>
	...
	<head>
		...
		<!-- Title -->
		<title>Post With Sidebar | Candidate HTML Template</title>
	  ...
	  fjs.parentNode.insertBefore(js, fjs);
		...
		<section id="content">	
			...
			<section class="section page-heading animate-onscroll">
				...
				<p class="breadcrumb"><a href="main-v1.html">Home</a> / Post With Sidebar</p>
					...
					<div class="col-lg-9 col-md-9 col-sm-8">
						...
						<div class="blog-post-single">
							...
							<div class="post-content">
								...
								<p class="animate-onscroll">Donec eget tellus non erat lacinia fermentum. Donec in velit vel ipsum auctor pulvinar. Vestibulum iaculis lacinia est. Proin dictum elementum velit. Fusce euismod consequat ante. Lorem ipsum dolor sit amet, consectetuer adipisMauris accumsan nulla vel diam. Sed in lacus ut enim adipiscing aliquet. </p>
