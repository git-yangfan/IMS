...
<html>
	...
	<head>
		...
		<!-- Title -->
		<title>1 Column Grid Portfolio With Right Sidebar | Candidate HTML Template</title>
	  ...
	  fjs.parentNode.insertBefore(js, fjs);
		...
		<section id="content">	
			...
			<section class="section page-heading animate-onscroll">
				...
				<h1>1 Column Grid Portfolio With Right Sidebar</h1>
				<p class="breadcrumb"><a href="main-v1.html">Home</a> / 1 Column Grid Portfolio With Right Sidebar</p>
