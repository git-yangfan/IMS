...
<html>
	...
	<head>
		...
		<!-- Title -->
		<title>Portfolio post with left sidebar | Candidate HTML Template</title>
	  ...
	  fjs.parentNode.insertBefore(js, fjs);
		...
		<section id="content">	
			...
			<section class="section page-heading animate-onscroll">
				...
				<h1>Portfolio post with left sidebar</h1>
				<p class="breadcrumb"><a href="main-v1.html">Home</a> / Portfolio post with left sidebar</p>
						...
						<div class="portfolio-single">
							...
							<div class="portfolio-slideshow flexslider animate-onscroll">
								...
								<ul class="slides">
									...
									<li>
										<img src="img/media/slide1-medium.jpg" alt="">
									</li>
									
									<li>
										<img src="img/media/slide2-medium.jpg" alt="">
									</li>
									
									<li>
										<img src="img/media/slide3-medium.jpg" alt="">
									</li>
