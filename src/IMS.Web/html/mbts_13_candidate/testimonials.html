...
<html>
	...
	<head>
		...
		<!-- Title -->
		<title>Testimonials | Candidate HTML Template</title>
	  ...
	  fjs.parentNode.insertBefore(js, fjs);
		...
		<section id="content">	
			...
			<section class="section page-heading animate-onscroll">
				...
				<h1>Testimonials</h1>
				<p class="breadcrumb"><a href="main-v1.html">Home</a> / Testimonials</p>
			...
			<section class="section full-width-bg gray-bg">
				...
				<div class="row">
					...
					<div class="col-lg-9 col-md-9 col-sm-8">
						...
						<h3 class="animate-onscroll no-margin-top">What people are saying</h3>
						...
						<div class="testimonial animate-onscroll">
							...
							<div class="testimonial-author">
								...
								<div class="author-meta">
									<span class="name">Alan Smith,</span>
									<span class="location">Los Angeles</span>
								</div>
							</div>
						...
						<div class="testimonial animate-onscroll">
							...
							<div class="testimonial-content">
								<p>"Duis ac turpis. Integer rutrum ante eu lacus.Vestibulum libero nisl, porta vel, scelerisque eget, malesuada at, neque. Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros.<br><br>
Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Suspendisse sollicitudin velit sed leo. Ut pharetra augue nec augue. Nam elit agna,endrerit sit amet, tincidunt ac, viverra sed, nulla."</p>
							</div>
							
							<div class="testimonial-author">
								<img src="img/testimonials/profile3.jpg" alt="">
								<div class="author-meta">
									<span class="name">Camala Haddon,</span>
									<span class="location">Los Angeles</span>
								</div>
							</div>
						...
						<div class="testimonial animate-onscroll">
							...
							<div class="testimonial-author">
								<img src="img/testimonials/profile4.jpg" alt="">
								<div class="author-meta">
									<span class="name">Bradley Grosh,</span>
									<span class="location">Los Angeles</span>
								</div>
							</div>
...
Vestibulum libero nisl, porta vel, scelerisque eget, malesuada at, neque. Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Suspendisse sollicitudin velit sed leo. Ut pharetra augue nec augue."</p>
							</div>
							
							<div class="testimonial-author">
								<img src="img/testimonials/profile5.jpg" alt="">
								<div class="author-meta">
									<span class="name">Patrick Pool,</span>
									<span class="location">Los Angeles</span>
								</div>
							</div>
						...
						<div class="testimonial animate-onscroll">
							...
							<div class="testimonial-author">
								<img src="img/testimonials/profile6.jpg" alt="">
								<div class="author-meta">
									<span class="name">Ivana Wong,</span>
									<span class="location">Los Angeles</span>
								</div>
							</div>
						...
						<div class="testimonial animate-onscroll">
							...
							<div class="testimonial-content">
								<p>"Vestibulum libero nisl, porta vel, scelerisque eget, malesuada at, neque. Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae."</p>
							</div>
							
							<div class="testimonial-author">
								<img src="img/testimonials/profile7.jpg" alt="">
								<div class="author-meta">
									<span class="name">Sandra Vancova,</span>
									<span class="location">Los Angeles</span>
								</div>
							</div>
						...
						<div class="testimonial animate-onscroll">
							...
							<div class="testimonial-content">
								<p>"Mauris accumsan nulla vel diam. Sed in lacus ut enim adipiscing aliquet. Nulla venenatis. In pede mi, aliquet sit amet, euismod in,auctor ut, ligula. Aliquam dapibus tincidunt metus. Praesent justo dolor, lobortis quis, lobortis dignissim, pulvinar ac, lorem. Vestibulum sed ante. Donec sagittis euismod purus."</p>
							</div>
							
							<div class="testimonial-author">
								<img src="img/testimonials/profile8.jpg" alt="">
								<div class="author-meta">
