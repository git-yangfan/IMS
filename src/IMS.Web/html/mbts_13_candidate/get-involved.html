...
<html>
	...
	<head>
		...
		<!-- Title -->
		<title>Get Involved | Candidate HTML Template</title>
						...
						<form>
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 col-sm-12 animate-onscroll">
									...
									<input type="checkbox" id="job-creation-chbx"><label for="job-creation-chbx">Job Creation and Growth</label><br>
									<input type="checkbox" id="dept-ceiling-chbx"><label for="dept-ceiling-chbx">Capping The Debt Ceiling</label><br>
									<input type="checkbox" id="healthier-america-chbx"><label for="healthier-america-chbx">A Healthier America</label><br>
									<input type="checkbox" id="secure-nation-chbx"><label for="secure-nation-chbx">A More Secure Nation </label><br>
									
									<h5>How can you help?</h5>
									
									<input type="checkbox" id="volunteer-chbx"><label for="volunteer-chbx">I would like to volunteer my time</label><br>
									<input type="checkbox" id="contribute-chbx"><label for="contribute-chbx">I would like to contribute financially</label><br>
									...
									<label>Friend Email Addresses<br>
<small>(Email addresses should be comma separated)</small></label>
