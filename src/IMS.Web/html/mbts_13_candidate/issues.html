...
<html>
	...
	<head>
		...
		<!-- Title -->
		<title>Issues | Candidate HTML Template</title>
	  ...
	  fjs.parentNode.insertBefore(js, fjs);
		...
		<section id="content">	
			...
			<section class="section page-heading animate-onscroll">
				...
				<h1>Issues</h1>
				<p class="breadcrumb"><a href="main-v1.html">Home</a> / Issues</p>
			...
			<section class="section full-width-bg gray-bg">
				...
				<div class="row">
					...
					<div class="col-lg-9 col-md-9 col-sm-8">
						...
						<h3 class="animate-onscroll no-margin-top">Main issues</h3>
						<p class="animate-onscroll">Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit. Aenean auctor wisi et urna. Aliquam erat volutpat. Duis ac turpis. Integer rutrum ante eu lacus. Vestibulum libero nisl, porta vel, scelerisque eget.</p>
							...
							<div class="col-lg-4 col-md-4 col-sm-12 animate-onscroll">
								...
								<div class="issue-block">
									...
									<div class="issue-content">
										...
										<p>Vestibulum iaculis lacinia est. Proin dictum elementum velit. Fusce euismod consequat ante. Lorem ipsum dolor sit.</p>
						...
						<h3 class="animate-onscroll">Other issues</h3>
