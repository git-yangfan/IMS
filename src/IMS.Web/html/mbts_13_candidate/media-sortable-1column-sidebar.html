...
<html>
	...
	<head>
		...
		<!-- Title -->
		<title>1 Column Sortable Portfolio With Right Sidebar | Candidate HTML Template</title>
	  ...
	  fjs.parentNode.insertBefore(js, fjs);
		...
		<section id="content">	
			...
			<section class="section page-heading animate-onscroll">
				...
				<h1>1 Column Sortable Portfolio With Right Sidebar</h1>
				<p class="breadcrumb"><a href="main-v1.html">Home</a> / 1 Column Sortable Portfolio With Right Sidebar</p>
				...
				<div class="row">
					...
					<div class="col-lg-9 col-md-9 col-sm-8">
						...
						<div class="media-items row">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 mix category-photos" data-nameorder="1" data-dateorder="3">
								...
								<div class="media-info">
									...
									<div class="media-header">
										...
										<div class="media-caption">
											<h2><a href="portfolio-single-sidebar.html">In pede mi, aliquet sit amet, euismod in</a></h2>
									...
									<div class="media-description">
										<p>Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit. Aenean auctor wisi et urna. Aliquam erat volutpat. Duis ac turpis. Integer rutrum ante eu lacus. Vestibulum libero nisl, porta vel, scelerisque eget, malesuada at...</p>
									</div>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 mix category-videos category-meetings" data-nameorder="2" data-dateorder="1">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 mix category-campaign category-videos category-meetings" data-nameorder="3" data-dateorder="2">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 mix category-campaign category-photos" data-nameorder="4" data-dateorder="5">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 mix category-videos category-meetings" data-nameorder="5" data-dateorder="4">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 mix category-campaign category-meetings" data-nameorder="6" data-dateorder="6">
