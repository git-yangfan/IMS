...
<html>
	...
	<head>
		...
		<!-- Title -->
		<title>Team | Candidate HTML Template</title>
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<h3 class="animate-onscroll no-margin-top">Meet our team</h3>
								...
								<div class="team-member animate-onscroll big">
									...
									<img class="team-member-image" src="img/team/1.jpg" alt="">
									
									<div class="team-member-info">
										
										<h2>Julie Anderson</h2>
										<span class="job">President of the United States</span>
										
										<div class="team-member-more">
											<p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Suspendisse sollicitudin velit sed leo. Ut pharetra augue nec augue. Nam elit agna,endrerit sit amet, tincidunt ac, viverra sed, nulla.</p><p>Donec porta diam eu massa. Quisque diam lorem, interdum vitae,dapibus ac, scelerisque vitae, pede. Donec eget tellus non erat lacinia fermentum. Donec in velit vel ipsum auctor pulvinar. Vestibulum iaculis lacinia est. Proin dictum elementum velit. Fusce euismod consequat ante.</p>
											<div class="social-media">
												<span class="small-caption">Get connected:</span>
												<ul class="social-icons">
													<li class="facebook"><a href="#" class="tooltip-ontop" title="Facebook"><i class="icons icon-facebook"></i></a></li><li class="twitter"><a href="#" class="tooltip-ontop" title="Twitter"><i class="icons icon-twitter"></i></a></li><li class="google"><a href="#" class="tooltip-ontop" title="Google Plus"><i class="icons icon-gplus"></i></a></li><li class="youtube"><a href="#" class="tooltip-ontop" title="Flickr"><i class="icons icon-youtube-1"></i></a></li><li class="flickr"><a href="#" class="tooltip-ontop" title="Flickr"><i class="icons icon-flickr-4"></i></a></li><li class="email"><a href="#" class="tooltip-ontop" title="Email"><i class="icons icon-mail"></i></a></li>												</ul>
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-6">
								...
								<div class="team-member animate-onscroll ">
									...
									<img class="team-member-image" src="img/team/8.jpg" alt="">
									
									<div class="team-member-info">
										
										<h2>Alan Smith</h2>
										<span class="job">Vice President of the United States</span>
										
										<div class="team-member-more">
											<p>Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros. Vestibulum ante ipsum primis in faucibus.</p><p>Vestibulum iaculis lacinia est. Proin dictum elementum velit. Fusce euismod consequat ante. Lorem ipsum dolor sit amet.</p>
											<div class="social-media">
												<span class="small-caption">Get connected:</span>
												<ul class="social-icons">
													<li class="facebook"><a href="#" class="tooltip-ontop" title="Facebook"><i class="icons icon-facebook"></i></a></li><li class="twitter"><a href="#" class="tooltip-ontop" title="Twitter"><i class="icons icon-twitter"></i></a></li><li class="google"><a href="#" class="tooltip-ontop" title="Google Plus"><i class="icons icon-gplus"></i></a></li><li class="youtube"><a href="#" class="tooltip-ontop" title="Flickr"><i class="icons icon-youtube-1"></i></a></li><li class="flickr"><a href="#" class="tooltip-ontop" title="Flickr"><i class="icons icon-flickr-4"></i></a></li><li class="email"><a href="#" class="tooltip-ontop" title="Email"><i class="icons icon-mail"></i></a></li>												</ul>
							...
							<div class="col-lg-4 col-md-4 col-sm-6">
								...
								<div class="team-member animate-onscroll ">
									...
									<img class="team-member-image" src="img/team/2.jpg" alt="">
							...
							<div class="col-lg-4 col-md-4 col-sm-6">
								...
								<div class="team-member animate-onscroll ">
									...
									<img class="team-member-image" src="img/team/3.jpg" alt="">
									...
									<div class="team-member-info">
										...
										<div class="team-member-more">
											...
											<div class="social-media">
												<span class="small-caption">Get connected:</span>
												<ul class="social-icons">
													<li class="facebook"><a href="#" class="tooltip-ontop" title="Facebook"><i class="icons icon-facebook"></i></a></li><li class="twitter"><a href="#" class="tooltip-ontop" title="Twitter"><i class="icons icon-twitter"></i></a></li>												</ul>
												<ul class="social-buttons">
																									</ul>
											</div>
										</div>
									...
									<div class="team-member-info">
										...
										<div class="team-member-more">
											...
											<div class="social-media">
												<span class="small-caption">Get connected:</span>
												<ul class="social-icons">
													<li class="facebook"><a href="#" class="tooltip-ontop" title="Facebook"><i class="icons icon-facebook"></i></a></li><li class="twitter"><a href="#" class="tooltip-ontop" title="Twitter"><i class="icons icon-twitter"></i></a></li><li class="google"><a href="#" class="tooltip-ontop" title="Google Plus"><i class="icons icon-gplus"></i></a></li>												</ul>
												<ul class="social-buttons">
																									</ul>
											</div>
										</div>
