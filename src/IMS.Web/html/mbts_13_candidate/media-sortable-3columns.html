...
<html>
	...
	<head>
		...
		<!-- Title -->
		<title>3 Column Sortable Portfolio | Candidate HTML Template</title>
	  ...
	  fjs.parentNode.insertBefore(js, fjs);
		...
		<section id="content">	
			...
			<section class="section page-heading animate-onscroll">
				...
				<h1>3 Column Sortable Portfolio</h1>
				<p class="breadcrumb"><a href="main-v1.html">Home</a> / 3 Column Sortable Portfolio</p>
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="media-items row">
							...
							<div class="col-lg-4 col-md-4 col-sm-6 mix category-videos category-meetings" data-nameorder="2" data-dateorder="1">
							...
							<div class="col-lg-4 col-md-4 col-sm-6 mix category-campaign category-videos category-meetings" data-nameorder="3" data-dateorder="2">
							...
							<div class="col-lg-4 col-md-4 col-sm-6 mix category-campaign category-photos" data-nameorder="4" data-dateorder="5">
							...
							<div class="col-lg-4 col-md-4 col-sm-6 mix category-videos category-meetings" data-nameorder="5" data-dateorder="4">
							...
							<div class="col-lg-4 col-md-4 col-sm-6 mix category-campaign category-meetings" data-nameorder="6" data-dateorder="6">
