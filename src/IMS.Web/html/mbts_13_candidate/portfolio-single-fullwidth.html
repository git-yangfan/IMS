...
<html>
	...
	<head>
		...
		<!-- Title -->
		<title>Full width portfolio post | Candidate HTML Template</title>
	  ...
	  fjs.parentNode.insertBefore(js, fjs);
		...
		<section id="content">	
			...
			<section class="section page-heading animate-onscroll">
				...
				<h1>Full width portfolio post</h1>
				<p class="breadcrumb"><a href="main-v1.html">Home</a> / Full width portfolio post</p>
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="portfolio-single">
							...
							<div class="portfolio-video animate-onscroll">
								<iframe src="//player.vimeo.com/video/51234218" width="1100" height="600"></iframe>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-4 col-md-4 col-sm-6 animate-onscroll">
									...
									<table class="project-details">
										...
										<tr>
											<td>Category:</td>
											<td><a href="#">Politics</a>, <a href="#">Photos</a></td>
										</tr>
										...
										<tr>
											<td>Skills:</td>
											<td><a href="#">Photoshop</a>, <a href="#">Illustrator</a></td>
										</tr>
										...
										<tr>
											<td>Tags:</td>
											<td><a href="#">meeting</a>, <a href="#">politics</a>, <a href="#">photos</a></td>
										</tr>
						...
						<div class="row portfolio-pagination">
							...
							<div class="col-lg-4 col-md-4 col-sm-4 align-left animate-onscroll">
								<a href="#" class="button big button-arrow-before">Prev project</a>
							</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-4 align-right animate-onscroll">
								<a href="#" class="button big button-arrow">Next project</a>
							</div>
						...
						<div class="related-media-items row">
							...
							<div class="media-item animate-onscroll gallery-media">
								...
								<h4 class="related-title"><a href="portfolio-single-sidebar.html">Donec porta diam eu massa</a></h4>								
							</div>
							<!-- /Media Item -->							
							</div>
							...
							<div class="media-item animate-onscroll gallery-media">
								...
								<div class="media-image">
									...
									<div class="media-hover">
										<div class="media-icons">
											<a href="https://www.youtube.com/watch?v=bd2B6SjMh_w" data-group="media-jackbox" data-thumbnail="img/media/media2-medium.jpg" class="jackbox media-icon"><i class="icons icon-play"></i></a>
											<a href="portfolio-single-sidebar.html" class="media-icon"><i class="icons icon-link"></i></a>
										</div>
									</div>
								...
								<h4 class="related-title"><a href="portfolio-single-sidebar.html">Vestibulum iaculis </a></h4>								
							</div>
							<!-- /Media Item -->							
							</div>
							...
							<div class="media-item animate-onscroll gallery-media">
								...
								<div class="media-image">
									...
									<div class="media-hover">
										<div class="media-icons">
											<a href="https://www.youtube.com/watch?v=bd2B6SjMh_w" data-group="media-jackbox" data-thumbnail="img/media/media3-medium.jpg" class="jackbox media-icon"><i class="icons icon-play"></i></a>
											<a href="portfolio-single-sidebar.html" class="media-icon"><i class="icons icon-link"></i></a>
										</div>
									</div>
								...
								<h4 class="related-title"><a href="portfolio-single-sidebar.html">Praesent justo dolor</a></h4>								
							</div>
							<!-- /Media Item -->							
							</div>
